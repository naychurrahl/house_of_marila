        ...
        {collections.map(collection => (
          <div key={collection.id} className="border border-neutral-200 p-6 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-sm mb-1 truncate">{collection.name}</h3>
              <p className="text-xs text-neutral-500 truncate">{collection.season} {collection.year} &middot; {collection.productIds.length} products</p>
            </div>
